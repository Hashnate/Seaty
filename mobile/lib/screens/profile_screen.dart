...
class _ProfileEditScreenState extends ConsumerState<ProfileEditScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final initialLetter = state.userName.isNotEmpty ? state.userName[0].toUpperCase() : 'U';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        style: const TextStyle(color: Color(0xFF0A2540), fontWeight: FontWeight.w600, fontSize: 14),
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        borderRadius: BorderRadius.circular(16),
                        style: const TextStyle(color: Color(0xFF0A2540), fontSize: 14, fontWeight: FontWeight.w600),
                        decoration: _buildInputDecoration('Select Gender', Icons.face_outlined),
                        items: ['Male', 'Female'].map((g) => DropdownMenuItem(
                          value: g,
                          child: Text(g, style: const TextStyle(color: Color(0xFF0A2540))),
                        )).toList(),
                        onChanged: (val) {
                          if (val != null) {
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            ...
                            disabledBackgroundColor: const Color(0xFFE65100).withValues(alpha: 0.5),
  ...
  InputDecoration _buildInputDecoration(String hint, IconData icon) {
    return InputDecoration(
      hintText: hint,
      hintStyle: TextStyle(color: const Color(0xFF94A3B8).withValues(alpha: 0.6), fontSize: 13),
